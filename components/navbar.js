		...
		>
			...
			>
				...
				>
					...
					<LinkItem
						href="https://drive.google.com/file/d/1oLy3Y_6nmzMHPZ4WmnEo7lGo7iVTEvrS/view?usp=sharing"
						path={path}
						target="_blank">
					...
					<Box mr={3} display={{ base: 'inline-block', md: 'none' }}>
						<Menu isLazy id='navbar-menu' backgroundColor={useColorModeValue('hsl(192, 12%, 8%)', 'hsl(192, 12%, 92%)')}>
							...
							<MenuList >
								...
								<MenuItem as={MenuLink} href="https://drive.google.com/file/d/1oLy3Y_6nmzMHPZ4WmnEo7lGo7iVTEvrS/view?usp=sharing">
									<CircleOption> Resume </CircleOption>
								</MenuItem>
